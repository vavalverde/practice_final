...
function ErrorsField(_a) {
    ...
    return !error && !children ? null : (react_1.default.createElement("div", Object.assign({ className: classnames_1.default('ui', className, 'error message') }, uniforms_1.filterDOMProps(props)),
        children,
